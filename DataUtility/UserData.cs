...
namespace DataGenerator
{
    ...
    public static class UserData
    {
        private static readonly List<Assignment> m_assignments = new List<Assignment>
        {
            new Assignment
            {
                RowKey = "14F831F8-2951-4FAB-8E76-68C925076793",
                Name = "Bæsj",
            ...
            new Assignment
            {
                RowKey = "36A7CDC7-BD3D-4876-B962-628870C0C72C",
                Name = "Tiss",
                Description = string.Empty,
                OncePerDay = false,
                Weight = 2,
            ...
            new Assignment
            {
                RowKey = "A2327835-C13C-406D-923B-6F44C992785B",
            ...
            new Assignment
            {
                RowKey = "D8998F3D-5378-410E-86FF-D20E935173B3",
                Name = "Tannpuss kveld",
                Description = string.Empty,
                OncePerDay = true,
                Weight = 1,
            ...
            new Assignment
            {
                RowKey = "CA55E579-76F9-4CFD-BDBB-A04736A20222",
                Name = "Matte",
                Description = string.Empty,
                OncePerDay = true,
                Weight = 5,
            ...
            new Assignment
            {
                RowKey = "D07BA9CB-E4DB-40F8-9461-A4EC36C66826",
                Name = "Lese",
                Description = string.Empty,
                OncePerDay = true,
                Weight = 5,
            ...
            new Assignment
            {
                RowKey = "CA3A3616-F1FE-4934-9D69-C9D00114E800",
                Name = "Rydde rommet",
                Description = string.Empty,
                OncePerDay = true,
                Weight = 7,
            ...
            new Assignment
            {
                RowKey = "E76BE7CD-B7E0-46BB-BE87-2296B52444F8",
                Name = "Rydde fat",
            ...
            new Assignment
            {
                RowKey = "1A3BA5D0-42A8-4123-82F8-DFB26756E29D",
                Name = "Rydde sekk",
            ...
            new Assignment
            {
                RowKey = "9A0F2632-E68B-4DDC-977C-DF40E67B7B3B",
                Name = "Henge opp klær",
                Description = string.Empty,
                OncePerDay = false,
                Weight = 2,
            ...
            new Assignment
            {
                RowKey = "FD3F8399-59CF-400D-A8DA-3C0884DE692C",
                Name = "Kle på selv",
                Description = string.Empty,
                OncePerDay = false,
                Weight = 2,
            ...
            new Assignment
            {
                RowKey = "6707DFD0-51DA-4BBD-95B4-721521B82837",
                Name = "Sykle",
                Description = string.Empty,
                OncePerDay = false,
                Weight = 1,
            ...
            new Assignment
            {
                RowKey = "93C83BD8-6DF3-4488-9DFB-8998D328D151",
                Name = "Stallen",
                Description = string.Empty,
                OncePerDay = true,
                Weight = 1,
            ...
            new Assignment
            {
                RowKey = "0E76A827-D309-47AE-AFCB-B2758DABEA88",
                Name = "Ri",
                Description = string.Empty,
                OncePerDay = true,
                Weight = 2,
            ...
            new Assignment
            {
                RowKey = "4F2C9358-D6CA-4A14-B78F-748A6C8653C9",
                Name = "Minecraft",
            ...
            new Assignment
            {
                RowKey = "D7573642-AF29-48C7-AFA2-4E3C6D3C7AFF",
                Name = "Tegne",
            ...
            new Assignment
            {
                RowKey = "3214D15A-C87C-4AAE-BA73-0FBB5C384C7D",
                Name = "Lage noe",
                Description = string.Empty,
                OncePerDay = false,
                Weight = 2,
        ...
        private static readonly List<User> m_users = new List<User>
        {
            new User
            {
                RowKey = "FB8FBF56-CA3A-4521-A8F1-748D42B9F8E3",
                Name = "Lilly",
                Avatar = "twa-girl",
                Goal = 100,
                XP = 0
            ...
            new User
            {
                RowKey = "C56A4180-65AA-42EC-A945-5FD21DEC0538",
                Name = "Robin",
                Avatar = "twa-boy",
                Goal = 100,
                XP = 0
